...
class FlaskAuth:
    ...
    def require_user(self):
        return _get_user_credential_decorator(self.auth.validate_access_token_and_get_user, True, self.debug_mode)
    
    @property
    def optional_user(self):
        return _get_user_credential_decorator(self.auth.validate_access_token_and_get_user, False, self.debug_mode)
    
    @property
    def require_org_member(self):
        return _get_require_org_decorator(self.auth.validate_access_token_and_get_user_with_org, self.debug_mode)
    
    @property
    def require_org_member_with_minimum_role(self):
        return _require_org_member_with_minimum_role_decorator(self.auth.validate_access_token_and_get_user_with_org_by_minimum_role, self.debug_mode)
    
    @property
    def require_org_member_with_exact_role(self):
        return _require_org_member_with_exact_role_decorator(self.auth.validate_access_token_and_get_user_with_org_by_exact_role, self.debug_mode)
    
    @property
    def require_org_member_with_permission(self):
        return _require_org_member_with_permission_decorator(self.auth.validate_access_token_and_get_user_with_org_by_permission, self.debug_mode)

    @property
    def require_org_member_with_all_permissions(self):
        return _require_org_member_with_all_permissions_decorator(self.auth.validate_access_token_and_get_user_with_org_by_all_permissions, self.debug_mode)
...
def init_auth(
    ...
    return FlaskAuth(auth_url=auth_url, integration_api_key=api_key, token_verification_metadata=token_verification_metadata, debug_mode=debug_mode)
