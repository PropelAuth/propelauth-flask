...
class FlaskAuth:
    ...
    def fetch_users_in_org(
        ...
        return self.auth.fetch_users_in_org(
    ...
    def update_user_email(
        ...
        return self.auth.update_user_email(
    ...
    def change_user_role_in_org(
        ...
        return self.auth.change_user_role_in_org(
    ...
    def set_saml_idp_metadata(self, org_id: str, saml_idp_metadata: SamlIdpMetadata):
        return self.auth.set_saml_idp_metadata(
    ...
    def fetch_scim_group(
        ...
        return self.auth.fetch_scim_group(org_id=org_id, group_id=group_id, members_page_size=members_page_size, members_page_number=members_page_number)
...
class FlaskAuthAsync:
    ...
    async def fetch_scim_group(
        ...
        return await self.auth.fetch_scim_group(org_id=org_id, group_id=group_id, members_page_size=members_page_size, members_page_number=members_page_number)
